  ...
  return (
    <div className="max-w-7xl mx-auto p-8 bg-white">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Business Equerry</h1>
        <p className="text-gray-600 text-lg">Any question or remarks? Just write us a message!</p>
      </div>

      {/* Main Content Container */}
      <div className="border-2  rounded-xl p-8 grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[600px]">
